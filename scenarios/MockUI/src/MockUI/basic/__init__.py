...
__all__ = ["BTN_HEIGHT", "BTN_WIDTH", "BACK_BTN_HEIGHT", "BACK_BTN_WIDTH",
           ...
           "STATUS_BAR_PCT", "SELECT_BAR_PCT", "CONTENT_PCT",
           ...
           "MainMenu", "LockedMenu", "DeviceBar", "WalletBar",
           "SelectAndManageBar", "SelectAndManageSeedsBar", "SelectAndManageWalletsBar",
           "ActionScreen",
